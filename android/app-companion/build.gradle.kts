...
android {
    ...
    compileSdk = 36
    defaultConfig {
        // This is the single PGR Companion Android module and produces the published listing.
        applicationId = "pk.vexel.pgrcompanion"
        minSdk = 26
        targetSdk = 36
        // Play has not received code 9; retain the available store version for this release.
        versionCode = 9
        versionName = "1.1.9"
    ...
    signingConfigs {
        create("release") {
            val releaseSigningRequested = gradle.startParameter.taskNames.any { taskName ->
                ...
                val targetsCompanion = taskName.contains("app-companion") || !taskName.contains(":app-")
                targetsCompanion && requestedTask in setOf("assemblerelease", "bundlerelease", "signingreport")
            }
