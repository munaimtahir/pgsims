...
- **ANY logbook/api/stats/** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY logbook/api/template/<int:template_id>/preview/** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY logbook/api/entry/<int:entry_id>/complexity/** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY logbook/api/update-statistics/** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY rotations/api/departments/<int:hospital_id>/** -> lib/api/training.ts (GET), lib/api/userbase.ts (POST), lib/api/departments.ts (PATCH), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/userbase.ts (DELETE), lib/api/training.ts (POST), lib/api/departments.ts (DELETE), lib/api/departments.ts (POST)
- **ANY rotations/api/quick-stats/** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
...
- **ANY api/^hospitals/$** -> lib/api/hospitals.ts (GET), lib/api/userbase.ts (POST), lib/api/userbase.ts (GET), lib/api/userbase.ts (PATCH), lib/api/hospitals.ts (DELETE), lib/api/hospitals.ts (PATCH), lib/api/userbase.ts (DELETE), lib/api/hospitals.ts (POST)
- **ANY api/^hospitals/(?P<pk>[^/.]+)/$** -> lib/api/hospitals.ts (GET), lib/api/userbase.ts (POST), lib/api/userbase.ts (GET), lib/api/userbase.ts (PATCH), lib/api/hospitals.ts (DELETE), lib/api/hospitals.ts (PATCH), lib/api/userbase.ts (DELETE), lib/api/hospitals.ts (POST)
- **ANY api/^hospitals/(?P<pk>[^/.]+)/departments/$** -> lib/api/hospitals.ts (GET), lib/api/userbase.ts (POST), lib/api/userbase.ts (GET), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/hospitals.ts (DELETE), lib/api/hospitals.ts (PATCH), lib/api/userbase.ts (DELETE), lib/api/departments.ts (POST), lib/api/hospitals.ts (POST)
- **ANY api/^departments/$** -> lib/api/userbase.ts (POST), lib/api/departments.ts (PATCH), lib/api/userbase.ts (GET), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/userbase.ts (DELETE), lib/api/departments.ts (DELETE), lib/api/departments.ts (POST)
- **ANY api/^departments/(?P<pk>[^/.]+)/$** -> lib/api/userbase.ts (POST), lib/api/departments.ts (PATCH), lib/api/userbase.ts (GET), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/userbase.ts (DELETE), lib/api/departments.ts (DELETE), lib/api/departments.ts (POST)
- **ANY api/^departments/(?P<pk>[^/.]+)/roster/$** -> lib/api/userbase.ts (POST), lib/api/departments.ts (PATCH), lib/api/userbase.ts (GET), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/userbase.ts (DELETE), lib/api/departments.ts (DELETE), lib/api/departments.ts (POST)
- **ANY api/^hospital-departments/$** -> lib/api/userbase.ts (POST), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/departments.ts (DELETE), lib/api/departments.ts (POST)
- **ANY api/^hospital-departments/(?P<pk>[^/.]+)/$** -> lib/api/userbase.ts (POST), lib/api/departments.ts (PATCH), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/userbase.ts (DELETE), lib/api/departments.ts (DELETE), lib/api/departments.ts (POST)
...
- **ANY api/^supervision-links/$** -> lib/api/userbase.ts (POST), lib/api/userbase.ts (GET), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/departments.ts (DELETE), lib/api/departments.ts (POST)
- **ANY api/^supervision-links/(?P<pk>[^/.]+)/$** -> lib/api/userbase.ts (POST), lib/api/userbase.ts (GET), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/departments.ts (DELETE), lib/api/departments.ts (POST)
- **ANY api/^hod-assignments/$** -> lib/api/userbase.ts (POST), lib/api/userbase.ts (GET), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/departments.ts (POST)
- **ANY api/^hod-assignments/(?P<pk>[^/.]+)/$** -> lib/api/userbase.ts (POST), lib/api/userbase.ts (GET), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/departments.ts (POST)
- **GET api/** -> lib/api/hospitals.ts (GET), lib/api/auth.ts (GET), lib/api/training.ts (GET), lib/api/users.ts (GET), lib/api/userbase.ts (GET), lib/api/departments.ts (GET), lib/api/bulk.ts (GET), lib/api/notifications.ts (GET), lib/api/audit.ts (GET)
- **POST api/** -> lib/api/notifications.ts (POST), lib/api/audit.ts (POST), lib/api/userbase.ts (POST), lib/api/training.ts (POST), lib/api/departments.ts (POST), lib/api/auth.ts (POST), lib/api/hospitals.ts (POST)
- **PUT api/** -> lib/api/training.ts (PUT)
- **PATCH api/** -> lib/api/departments.ts (PATCH), lib/api/training.ts (PATCH), lib/api/userbase.ts (PATCH), lib/api/notifications.ts (PATCH), lib/api/hospitals.ts (PATCH), lib/api/auth.ts (PATCH)
- **DELETE api/** -> lib/api/departments.ts (DELETE), lib/api/training.ts (DELETE), lib/api/hospitals.ts (DELETE), lib/api/userbase.ts (DELETE)
...
- **GET api/admin/data-quality/users** -> lib/api/users.ts (GET), lib/api/userbase.ts (GET)
...
- **GET api/users/assigned-pgs/** -> lib/api/users.ts (GET), lib/api/userbase.ts (GET)
...
- **ANY api/users/^$** -> lib/api/userbase.ts (PATCH), lib/api/userbase.ts (POST), lib/api/users.ts (GET), lib/api/userbase.ts (GET)
- **ANY api/users/^(?P<pk>[^/.]+)/$** -> lib/api/userbase.ts (PATCH), lib/api/userbase.ts (POST), lib/api/users.ts (GET), lib/api/userbase.ts (GET)
- **GET api/users/** -> lib/api/users.ts (GET), lib/api/userbase.ts (GET)
...
- **ANY api/programs/<int:program_id>/milestones/^$** -> lib/api/training.ts (GET), lib/api/training.ts (PUT), lib/api/training.ts (POST)
- **ANY api/programs/<int:program_id>/milestones/^(?P<pk>[^/.]+)/$** -> lib/api/training.ts (GET), lib/api/training.ts (PUT), lib/api/training.ts (POST)
...
- **ANY api/^programs/$** -> lib/api/training.ts (GET), lib/api/training.ts (PUT), lib/api/training.ts (POST)
- **ANY api/^programs/(?P<pk>[^/.]+)/$** -> lib/api/training.ts (GET), lib/api/training.ts (PUT), lib/api/training.ts (POST)
- **ANY api/^program-templates/$** -> lib/api/training.ts (DELETE), lib/api/training.ts (GET), lib/api/training.ts (POST), lib/api/training.ts (PATCH)
- **ANY api/^program-templates/(?P<pk>[^/.]+)/$** -> lib/api/training.ts (DELETE), lib/api/training.ts (GET), lib/api/training.ts (POST), lib/api/training.ts (PATCH)
- **ANY api/^resident-training/$** -> lib/api/training.ts (GET)
- **ANY api/^resident-training/(?P<pk>[^/.]+)/$** -> lib/api/training.ts (GET)
- **ANY api/^rotations/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/activate/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/complete/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/confirm-completion/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/hod-approve/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/reject/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/returned/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/review-application/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/submit/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/utrmc-approve/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/(?P<pk>[^/.]+)/verify-completion/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^leaves/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
...
- **ANY api/^postings/$** -> lib/api/training.ts (DELETE), lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^postings/(?P<pk>[^/.]+)/$** -> lib/api/training.ts (DELETE), lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^postings/(?P<pk>[^/.]+)/approve/$** -> lib/api/training.ts (DELETE), lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^postings/(?P<pk>[^/.]+)/complete/$** -> lib/api/training.ts (DELETE), lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^postings/(?P<pk>[^/.]+)/reject/$** -> lib/api/training.ts (DELETE), lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^workshops/$** -> lib/api/training.ts (DELETE), lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^workshops/(?P<pk>[^/.]+)/$** -> lib/api/training.ts (DELETE), lib/api/training.ts (GET)
- **ANY api/^logbook/config/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST), lib/api/training.ts (PATCH)
- **ANY api/^logbook/config/(?P<pk>[^/.]+)/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^logbook/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST), lib/api/training.ts (PATCH)
- **ANY api/^logbook/(?P<pk>[^/.]+)/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST), lib/api/training.ts (PATCH)
- **ANY api/^logbook/(?P<pk>[^/.]+)/review/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST), lib/api/training.ts (PATCH)
- **ANY api/^logbook/(?P<pk>[^/.]+)/submit/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST), lib/api/training.ts (PATCH)
- **ANY api/^logbook/(?P<pk>[^/.]+)/verify/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST), lib/api/training.ts (PATCH)
- **ANY api/^submissions/requirements/$** -> lib/api/training.ts (GET)
- **ANY api/^submissions/requirements/(?P<pk>[^/.]+)/$** -> lib/api/training.ts (GET)
- **ANY api/^rotations/requirements/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **ANY api/^rotations/requirements/(?P<pk>[^/.]+)/$** -> lib/api/training.ts (GET), lib/api/training.ts (POST)
- **GET api/** -> lib/api/hospitals.ts (GET), lib/api/auth.ts (GET), lib/api/training.ts (GET), lib/api/users.ts (GET), lib/api/userbase.ts (GET), lib/api/departments.ts (GET), lib/api/bulk.ts (GET), lib/api/notifications.ts (GET), lib/api/audit.ts (GET)
- **POST api/** -> lib/api/notifications.ts (POST), lib/api/audit.ts (POST), lib/api/userbase.ts (POST), lib/api/training.ts (POST), lib/api/departments.ts (POST), lib/api/auth.ts (POST), lib/api/hospitals.ts (POST)
- **PUT api/** -> lib/api/training.ts (PUT)
- **PATCH api/** -> lib/api/departments.ts (PATCH), lib/api/training.ts (PATCH), lib/api/userbase.ts (PATCH), lib/api/notifications.ts (PATCH), lib/api/hospitals.ts (PATCH), lib/api/auth.ts (PATCH)
...
- **ANY academics/api/^departments/(?P<pk>[^/.]+)/$** -> lib/api/userbase.ts (POST), lib/api/departments.ts (PATCH), lib/api/departments.ts (GET), lib/api/userbase.ts (PATCH), lib/api/userbase.ts (DELETE), lib/api/departments.ts (DELETE), lib/api/departments.ts (POST)
