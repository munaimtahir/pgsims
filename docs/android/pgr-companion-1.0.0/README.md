# PGR Companion – Residency Portfolio

Independent, login-free Android portfolio for postgraduate medical trainees. The public app is package `pk.vexel.pgrcompanion`, version `1.0.0` / code `1`, min SDK 26 and target SDK 36.

## Product facts

- Local-only profile, rotations, activities, milestones, reminders and app-private document copies.
