...
export default function DataQualityReportPage() {
  ...
  const handleExportCSV = () => {
    const url = `${apiClient.defaults.baseURL || ''}/api/academics/reports/data-quality/export.csv`;
    ...
    <ProtectedRoute allowedRoles={['ADMIN']}>
      <div className="pg-page space-y-6">
        <div className="flex items-center justify-between">
          <PageHeader
            title="Data Quality & Compliance Audit"
            description="Identify compliance discrepancies including residents missing active training records, supervisor mapping gaps, and low logbook counts."
          />
          <button
