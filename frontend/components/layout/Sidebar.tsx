...
function Icon({ name, className = 'h-5 w-5' }: { name: string; className?: string }) {
  const icons: Record<string, JSX.Element> = {
    ...
    briefcase: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 13V8a2 2 0 00-2-2h-3V5a2 2 0 00-2-2h-2a2 2 0 00-2 2v1H6a2 2 0 00-2 2v5m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-4m-8 0H4m8 0v1m0-1h0" />,
    collection: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h16M4 18h16" />,
    ...
    'queue-list': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 6h11M9 12h11M9 18h11M5 6h.01M5 12h.01M5 18h.01" />,
    ...
    'user-circle': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A9 9 0 1118.88 17.8M15 11a3 3 0 11-6 0 3 3 0 016 0zm-3 6c-2.761 0-5 1.567-5 3.5h10c0-1.933-2.239-3.5-5-3.5z" />,
