...
- Playwright isolated canonical stack: smoke PASS (25/25); workflow-gate CONDITIONAL (1/4 passed,
  3 stale workflow-contract failures); no RBAC certification claimed.
