...
- Frontend Jest: PASS (39 suites, 243 tests).
...
- Playwright isolated canonical stack: 11/25 smoke tests passed; 14 stale-contract failures; no
  workflow/RBAC certification claimed.
