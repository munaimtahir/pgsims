...
echo "=========================================="
docker compose -f ../../docker/docker-compose.yml -p "$COMPOSE_PROJECT_NAME" logs --tail=20 worker

echo "=========================================="
echo "Beat service logs (last 20 lines):"
echo "=========================================="
docker compose -f ../../docker/docker-compose.yml -p "$COMPOSE_PROJECT_NAME" logs --tail=20 beat
