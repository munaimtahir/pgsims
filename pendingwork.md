...
- [ ] WEB-DISC-001 — Repair admin monitoring Jest mock/API contract. Module/role: admin dashboard/ADMIN. Status: BUILT_NEEDS_DEBUG; P1. Frontend: mock `getAdminDashboardMonitoring` and assert response rendering. Backend: none identified. Evidence: `docs/discovery/evidence/20260919_command_results.txt`; `frontend/app/dashboard/utrmc/page.tsx:26`; `frontend/app/dashboard/utrmc/page.test.tsx:15-19`. Acceptance: focused page test and full Jest pass.
